...
function updateRedDot(fromUser) {
    ...
    document.querySelectorAll(`.pro[data-username="${fromUser}"]`).forEach(card => {
...
if (document.getElementById("userList")) {
    ...
    socket.on("users", users => {
        ...
        users.filter(u => u.username !== user).forEach(u => {
            ...
            li.innerHTML = `
                <span style="font-size:15px;font-weight:600;color:#e8eaed;letter-spacing:0.5px;">
                    ${u.username}
                </span>
            `;
            ...
            if (u.online) {
                ...
                `;
                li.querySelector("span").appendChild(dot);
            }
            ...
            button.style.cssText = `
                ...
                border-radius:12px;background:#00e5a0;
                color:#080a0c;cursor:pointer;font-weight:bold;
            `;
            ...
            button.addEventListener("click", e => { e.stopPropagation(); goToProfile(); });
            ...
            if (localStorage.getItem("isAdmin") === "true") {
                ...
                delBtn.style.cssText = `
                    margin-top:8px;margin-left:8px;padding:10px 16px;
                    border:none;border-radius:12px;background:#ff4d6d;
